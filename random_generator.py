...
def show_inverse_transform():
    st.markdown("""
        <div style='text-align: right; direction: rtl;'>
            ...
            <p>שיטת הטרנספורם ההופכי היא שיטה ליצירת דגימות מהתפלגות כלשהי על סמך פונקציית ההתפלגות המצטברת ההופכית (CDF הפוך). שיטה זו שימושית במיוחד עבור התפלגויות בהן יש ביטוי אנליטי לפונקציה המצטברת ההפוכה.</p>
...
def show_rng_demo():
    ...
    st.markdown("""
        ...
        <div class='rtl'>
            ...
            <h3>כדי לדגום מספרים המתפלגים אחיד בין 0-1, נשתמש בשתי שיטות שונות לייצור מספרים פסאודו-אקראיים:</h3>
        </div>
    """, unsafe_allow_html=True)
